...
const description = document.querySelector('#current-cond');
const captionDesc = document.querySelector('figcaption');

const url = "https://api.openweathermap.org/data/2.5/weather?q=Fairbanks&units=imperial&appid=dc73736434f97a683e7d8dfe5d65348e"
...
async function apiFetch() {
  try {
    ...
    if (response.ok) {
      ...
      console.log(data); //this is for testng the call displayResults(data);
      displayResults(data);
    } else {
